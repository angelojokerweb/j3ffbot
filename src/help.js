...
desc : imagens de memes aleatÃ³rios [english]
uso : just send the command\n
comando : *${prefix}memeindo (off)*
desc : imagens de memes aleatÃ³rios [indo]
uso : just send the command\n
> *,?Outros Comandos?* <
comando : *${prefix}gtts*
...
desc : imagens nsfw aleatÃ³rias de loli
uso : just send the command\n
...
uso : reply image, or send image with caption\n
comando : *${prefix}wait*
desc : pesquisar anime com imagem [Que anime Ã© isso / aquilo]
uso : reply image, or send image with caption\n
...
note : s¨® pode ser usado quando o bot se torna admin, e quem envia o comando Ã© admin!\n
comando : *${prefix}ban*
...
desc : faz o bot sair do grupo (faz isso n?o :( )
uso : just send the command
note : S¨® pode ser usado por administradores de grupo e proprietÃ¡rio do bot\n
