		...
		try {
			...
			mess = {
				...
				only: {
					...
					admin: '❌ Este comando só pode ser usado por Ademiros de grupo, Membro comum! 👺❌',
					Badmin: '❌ Este comando só pode ser usado quando o bot se torna administrador! ❌'
				}
			}

			const botNumber = client.user.jid
			const ownerNumber = ["5564992606313@s.whatsapp.net"] // replace this with your number
			...
			switch(command) {
				...
				case 'kick':
					...
					if (mentioned.length > 1) {
						...
						mentions(`TOMOU O FAMOSO BAN DO ADEMA 😳🤙 : @${mentioned[0].split('@')[0]}`, mentioned, true)
						client.groupRemove(from, mentioned)
					}
					break
				case 'listadmins':
